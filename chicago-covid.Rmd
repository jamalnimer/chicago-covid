...
ggsave("chicago-covid2/non_white.png", scale = 0.2)


corona <- plot_corona()
ggsave("figures/corona.png")
ggsave("chicago-covid2/corona.png", scale = 0.2)
...
alternate_model <- lm(cases_per_1000 ~ majority, data = chicago_analysis) %>% 
  tidy()
...
# non_white_model <- lm(cases_per_1000 ~ percent_non_white, data = chicago_analysis) %>% 
#   tidy() %>% 
#   select(term, estimate) %>% 
#   filter(term == "percent_non_white")
...
# data sets
saveRDS(object = chicago, file = "chicago-covid2/chicago.RDS")
saveRDS(object = chicago_analysis, file = "chicago-covid2/chicago_analysis.RDS")

# graphs
saveRDS(object = hispanic, file = "chicago-covid2/hispanic.RDS")
saveRDS(object = black, file = "chicago-covid2/black.RDS")
saveRDS(object = white, file = "chicago-covid2/white.RDS")
saveRDS(object = non_white, file = "chicago-covid2/non_white.RDS")
saveRDS(object = corona, file = "chicago-covid2/corona.RDS")
